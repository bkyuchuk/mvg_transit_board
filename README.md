...
Since I travel to uni by taking the U2 and changing at Scheidplatz to U3, I want to know which U2 arrivals at Scheidplatz correspond exactly to U3 departures so that I don't have to wait. These U2 connections should be marked on the e-paper display.
...
1. Let Arduino install all initial libraries
2. Connect the Waveshare board to your PC
3. Add `https://dl.espressif.com/dl/package_esp32_index.json` in _File/Preferences_ under _"Additional boards manager URLs"_
4. Click on the _"Select Board"_ dropdown and from the _"Boards"_ dropdown choose _"ESP32 Dev Module"_ (it should now be active) and select your board USB connection under _"Ports"_
5. Install the [ArduinoJson](https://arduinojson.org/v6) and the e-paper display interaction library [GxEPD2](https://github.com/ZinggJM/GxEPD2) by going to _Sketch_ > _Include Library_ > _Manage Libraries_
